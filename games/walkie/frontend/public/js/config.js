const CONFIG = {
  API_URL: process.env.NEXT_PUBLIC_API_URL || 'https://your-api-url',
  WS_URL: process.env.NEXT_PUBLIC_WS_URL || 'wss://your-api-url',

  CHAIN_ID: 143,
  CHAIN_NAME: 'Monad Mainnet',
  RPC_URL: process.env.RPC_URL || 'https://mainnet.monad.xyz',
  EXPLORER_URL: process.env.EXPLORER_URL || 'https://explorer.monad.xyz',
  CURRENCY: {
    name: 'MON',
    symbol: 'MON',
    decimals: 18
