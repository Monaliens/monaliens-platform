...
// Keno Audio Manager - Lazy loading & Memory management
...
const SOUNDS = {
  ...
  select: '/assets/sounds/keno/select.mp3',
  reveal: '/assets/sounds/keno/reveal.mp3',
  match: '/assets/sounds/keno/match.mp3',
