...
// Plinko Audio Manager - Lazy loading & Memory management
...
// Sound paths
const SOUNDS = {
  bet: '/assets/sounds/plinko/bet.mp3',
  pin: '/assets/sounds/plinko/pin.mp3',
  win: '/assets/sounds/plinko/win.mp3',
  lose: '/assets/sounds/plinko/lose.mp3'
};
