...
// Dice Audio Manager - Lazy loading & Memory management
...
const SOUNDS = {
  ...
  rolling: '/assets/sounds/dice/rolling.mp3',
  tick: '/assets/sounds/dice/tick.mp3',
...
const playSound = async (soundKey, options = {}) => {
  try {
    ...
    if (playPromise) {
      ...
      return audioToPlay; // Return audio element so we can stop it if looping
    }
