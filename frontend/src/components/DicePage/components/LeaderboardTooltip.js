...
import { getLeaderboard } from '../utils/diceApi';
import monadIcon from '../../../assets/images/monad.png';
import { useWatchContractEvent } from 'wagmi';
import { DICE_CONTRACT_ADDRESS, DICE_ABI } from '../utils/constants';
...
const LeaderboardTooltip = ({ isOpen, panelRef, maxHeight }) => {
  ...
  // Dice GameResult event includes betAmount, so no need for pending games
